        ...
        <ul class="ml-auto d-flex align-items-center list-unstyled mb-0">
            ...
            <li class="nav-item dropdown ml-auto">
                <a id="userInfo" href="http://example.com" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">
                    <img src="<%=application.getContextPath()%>/img/chefprojet.png" alt="Chef projet" style="max-width: 2.5rem;" class="img-fluid rounded-circle shadow">
                </a>
                <div aria-labelledby="userInfo" class="dropdown-menu">
                    <a href="#" class="dropdown-item">
                        <strong class="d-block text-uppercase headings-font-family">Chef de projet</strong>
            ...
            <section class="py-5">
                <div class="row">
                    <%
                        ...
                        questionnaires = (ArrayList<String[]>) request.getAttribute("questionnaires") ;
                        for (int i = 0 ; i < questionnaires.size() ; i++) {
                    %>
                    <div class="col-lg-12">
                        <a href="<%=application.getContextPath()%>/ChefProjetShowAnswersServlet?user_name=<% out.print(questionnaires.get(i)[0]);%>&nom_quiz=<% out.print(questionnaires.get(i)[1]); %>" class="message card px-5 py-3 mb-4 bg-hover-gradient-primary no-anchor-style">
                            <div class="row">
                                <div class="col-lg-3 d-flex align-items-center flex-column flex-lg-row text-center text-md-left">
                                    <strong class="h5 mb-0">
                                        <h6 class="mb-0"><% out.print(questionnaires.get(i)[0]); %></h6>
                                    </strong>
                                    <img src="<%=application.getContextPath()%>/img/user.png" alt="..." style="max-width: 3rem" class="rounded-circle mx-3 my-2 my-lg-0">
                                </div>
                                <div class="col-lg-9 d-flex align-items-center flex-column flex-lg-row text-center text-md-left">
                                    <p class="mb-0 mt-3 mt-lg-0"><% out.print(questionnaires.get(i)[1]); %></p>
                                </div>
                            </div>
                        </a>
                    </div>
