...
<html>
  <head>
    ...
    <title>Questionnaire employee</title>
  ...
  <body>
    ...
    <header class="header">
        <nav class="navbar navbar-expand-lg px-4 py-2 bg-white shadow">
            ...
            <a href="home.jsp" class="navbar-brand font-weight-bold text-uppercase text-base">Page principale</a>
    ...
    <div class="d-flex align-items-stretch">
      <div id="sidebar" class="sidebar py-3">
        ...
        <ul class="sidebar-menu list-unstyled">
          ...
          <li class="sidebar-list-item"><a href="Questionnaire.jsp" class="sidebar-link text-muted"><i class="o-survey-1 mr-3 text-gray"></i><span>Recommandations</span></a></li>
                ...
                <div class="card">
                  <div class="card-header">
                    <h3 class="h6 text-uppercase mb-0">
                        <%
                        String nom_quiz = (String)request.getAttribute("nom_quiz");
                        out.println(nom_quiz);
                        %>
                    </h3>
                  </div>

                  <div class="card-body">
                    <form class="form-horizontal" action="reponse" method="post">
                        <%
                            ArrayList<String> array = (ArrayList<String>) request.getAttribute("questions");
                            for (int i = 0 ; i <array.size() ; i++) {
                        %>
                        <div class="form-group row">
                            <label class="col-md-9 form-control-label"><%=array.get(i) %></label>
                            <div class="col-md-3">
                                <select name="choice">
                                ...
                                <label class="checkbox-inline">
                                    <input id="inlineCheckbox1" name="true_input" type="checkbox" value="true"> Vrai
                                </label>
                                <label class="checkbox-inline">
                                    <input id="inlineCheckbox2" name="false_input" type="checkbox" value="false"> Faux
                                </label>
                                -->
                            </div>
                        </div>
                        <input type="hidden" value="<%=array.get(i)%>" name="question" />
                        <%  } %>
                      <div class="col-md-4 center-block">
                        <button type="submit" class="btn btn-primary shadow px-5 align-self-center">Envoyer</button>
                      </div>
                    </form>
