...
<head>
    ...
    <title>Chef de Projet poser recommandation</title>
            ...
            <li class="nav-item dropdown ml-auto">
                ...
                <div aria-labelledby="userInfo" class="dropdown-menu">
                    <a href="#" class="dropdown-item">
                        <strong class="d-block text-uppercase headings-font-family">Chef Projet</strong>
                        <small>chef projet</small>
                    </a>
                    ...
                    <div class="col-lg-12 mb-5">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="h6 text-uppercase mb-0">Reponse questionnaire : 1</h3>
                            </div>
                            <div class="card-body">
                                <form action="SetRecommandationServlet" method="post">

                                    <div class="form-group row">
                                        <label class="col-sm-3 form-control-label">Recommandation</label>
                                        <div class="col-md-9">
                                            <textarea name="Recommandation" id="inputHorizontalWarning" type="text" placeholder="Recommandation" class="form-control form-control-warning" rows="4" required></textarea>
                                        </div>
                                    </div>
