                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 mb-5">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal" action="PoserRecommandationChefProjet.jsp">
                                    <div class="form-group row">
                                        <label class="col-md-9 form-control-label">If you want to highlight one word at a time, press Ctrl key while holding down Shift, and then press the left or right arrow key.</label>
                                        <div class="col-md-3">
